...
def main():
    ...
    """
    # File paths
    input_file = "/home/plotnikovgp/Baikal-ML/pytorch_training/data/baikal_mc2020_multi_split_0924h8s2_tl100_norm_wcluster_fix.h5"
    cluster_centers_file = "/home/plotnikovgp/Baikal-ML/pytorch_training/data/baikal_mc2020_multi_split_0924_clusters_centers.txt"
    split = "train"
